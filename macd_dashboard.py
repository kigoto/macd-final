...
st.title("📊 MACD + VWAP + Option Chain Dashboard with Full Fixes")
...
def render_dashboard():
    ...
    if last_price and not calls.empty:
        ...
        st.warning("No call options found or invalid price.")
    ...
    if last_price and not puts.empty:
        ...
        st.warning("No put options found or invalid price.")
